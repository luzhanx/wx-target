    ...
    wx.getImageInfo({
      ...
      success: function success(res) {
        ...
        if (IMG_RATIO >= 1) {
          ...
          var lr = (SCREEN_WIDTH * IMG_RATIO - (Math.ceil((SCREEN_WIDTH * IMG_RATIO / IMG_RATIO - t * 2)) + 4)) / 2;
          wx.setNavigationBarColor({
            frontColor: "#000000",
            backgroundColor: '#000000',
          })
  ...
  dragMove(e) {
    ...
    switch (dragType) {
      ...
      case 'left':
        ...
        if ((CUT_B - dragLength) > (this.data.cropperW - this.data.cutR)) dragLength = CUT_B - (this.data.cropperW - this.data.cutR)
        this.setData({
      ...
      case 'top':
        ...
        if (CUT_L - dragLength < 0) dragLength = CUT_L
        if ((CUT_L - dragLength) > (this.data.cropperH - this.data.cutB)) dragLength = CUT_L - (this.data.cropperH - this.data.cutB)
